...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        private void btConnect_Click(object sender, EventArgs e)
        {
            ...
            //this.personTableAdapter.FillByName(this.infosys202106DataSet.Person,"髙");
        }

        private void btNameFilter_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202106DataSet.Person, tbNameSearch.Text);
        }
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            //一部アップデート
            //this.personTableAdapter.Update(this.infosys202106DataSet.Person);
